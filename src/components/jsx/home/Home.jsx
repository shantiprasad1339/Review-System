...
useEffect(()=>{
  ...
  async function getClients() {
    try {
      ...
      const responseClients = await axios.get(`http://64.227.167.55:8080/A2G/top_Client_data/?curr_location=${city}`);
      console.log(responseClients.data.data);
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12 col-xl-6 mt-n5">
              <div>
                <h1
                  className="hero-one-title fw-bold aos-init aos-animate"
                  data-aos="fade-up"
                ...
                <div className="mt-60 d-flex flex-column flex-sm-row flex-wrap gap-4 align-items-center">
                  <div className="d-flex gap-3 align-items-center">
                    <div className="hero-group-img-wrapper">
                      <img src={hc_1} className="hero-group-img" alt="" />
                      <img src={hc_2} className="hero-group-img" alt="" />
                      <img src={hc_3} className="hero-group-img" alt="" />
                    </div>
                    <div>
            ...
            <div className="col-md-12 col-xl-6 mt-5 mt-xl-0">
              <div className="">
                <img
                  src={big_b}
                  className="hero-one-img text-end img-fluid"
                  alt=""
                />
              </div>
            </div>
      ...
      <section className="bg-offWhite py-110">
        <div className="container">
          <div class="row mb-30 justify-content-between align-items-end">
          ...
          <div className="row">
            ...
            <div class="col-md-auto">
              <h2 class="fw-bold section-title">Featured Task</h2>
            ...
            <div className="col-xl-12 mt-4">
              <div className="inter_slider">
                <Swiper
                  ...
                  className="mySwiper"
                >
                  {clients&& clients.map((slidedata_1, k1) => {
                     const date = new Date(slidedata_1.created_at);

                     const givenHour = date.getHours();
     
                     const currentHour = new Date().getHours();
     
                     const hoursAgo = currentHour - givenHour;
                    return(
                      <SwiperSlide>
                        <Link to={token?`/bids-details/${slidedata_1.id}`:'/login'}>
                          <div className="filter_box" onClick={()=>navigateTodetails(slidedata_1.id)}>
                            <div className="image">
                              <img
                                src={"https://"+slidedata_1.image_path}
                                alt=""
                              />
                            </div>
                            <div className="content">
                              <div className="box_1">
                                <h4>{slidedata_1.field_name}</h4>
                                <span className="price">
                                  Budget {} INR – {slidedata_1.cost} INR
                                </span>
                                <span className="location">
                                  <i className="fa-solid fa-location-dot"></i>{" "}
                                  {slidedata_1.location}
                                </span>
                                <span className="task">
                                  Total Review Task{slidedata_1.total_reviews}
                                </span>
                              ...
                              <div style={{ width: 150, height: 150 }}>
                                <CircularProgressbar
                                  value={slidedata_1.percentage}
                                  text={`${slidedata_1.percentage}%`}
                                />
                              </div>
        ...
        <div class="container">
          <div class="bg-darkGreen cta-area-bg">
            <div class="row align-items-center">
              <div class="  col-xl-7">
                <div
                  class="cta-content aos-init aos-animate"
                  data-aos="fade-up"
                  data-aos-duration="1000"
                  data-aos-easing="linear"
                >
